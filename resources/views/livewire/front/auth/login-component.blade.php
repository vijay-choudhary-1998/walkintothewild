            ...
            <form class="row form-vertical mb-3 loginformsedit" wire:submit.prevent="login">
                ...
                <div class="col-lg-9 col-md-11 mb-3">
                    ...
                    <input type="email" class="form-control new_input new_input_margin" wire:model="email"
                        id="inputEmailAddress" placeholder="Email Address" value=""
                ...
                <div class="col-lg-9 col-md-11 mb-3">
                    ...
                    <div class="input-group" id="show_hide_password">
                        <input
                            type="password"
                            class="form-control border-end-0 new_input new_input_margin"
                            placeholder="Password"
                            id="inputChoosePassword"
                            wire:model="password"
                            autocomplete="password">
                        <a href="javascript:void(0);" class="input-group-text bg-transparent new_input_margin" onclick="togglePassword()">
                ...
                <div class="col-lg-9 col-md-11 mb-md-0 mb-3">
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary  py-2" wire:loading.attr="disabled">
                            ...
                            <span wire:loading><i class="spinner-border spinner-border-sm" role="status"></i> Loading...</span>
                        </button>
                    </div>
                </div>
            </form>
